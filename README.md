...
```aidl
docker-compose -f zookeeper-kafka-setup.yml up

docker-compose -f zookeeper-kafka-setup.yml down

```
==========================================================================
============= Issue and resolution =======================================

If you are getting this issue:
ERROR: Head "https://registry-1.docker.io/v2/confluentinc/cp-zookeeper/manifests/7.1.0": unauthorized: incorrect username or password

then do this:

Then login to the docker using this:
